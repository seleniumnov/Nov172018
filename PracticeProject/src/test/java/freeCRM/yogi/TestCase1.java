...
public class TestCase1 {
	...
	try {
	    ...
	    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	    Select dropdown = new Select(driver.findElement(By.xpath("//form[@id='companyForm']/table/tbody/tr[2]/td[1]/table/tbody/tr[5]/td[2]/select")));
	    dropdown.selectByValue("Hot");
	 
	    Select dropdown1=new Select(driver.findElement(By.xpath("//form[@id='companyForm']/table/tbody/tr[2]/td[1]/table/tbody/tr[6]/td[2]/select")));
	    dropdown1.selectByValue("Client");
	    
	    Select dropdown2=new Select(driver.findElement(By.xpath("//form[@id='companyForm']/table/tbody/tr[2]/td[1]/table/tbody/tr[7]/td[2]/select")));
	    dropdown2.selectByValue("High");
	    Select dropdown3=new Select(driver.findElement(By.xpath("//form[@id='companyForm']/table/tbody/tr[2]/td[1]/table/tbody/tr[8]/td[2]/select")));
       ...
       //WebElement savebutton=driver.findElement(By.xpath("//form[@id='companyForm']/table/tbody/tr[8]/td/input"));
       //savebutton.click();
     //form[@id='companyForm']/table/tbody/tr[2]/td[1]/table/tbody/tr/td/input
      /* List<WebElement> questionmarks=driver.findElements(By.xpath("//form[@id='companyForm']/table/tbody/tr[2]/td[1]/table/tbody/tr/td/input")); 
       for(int k=0;k<questionmarks.size();k++)
       {
    	   String txt = questionmarks.get(k).getText();
			 System.out.println(txt);
			 if(txt.contains("button"))
			 {
				 
				 questionmarks.get(k).click();
				 break;
			 }
