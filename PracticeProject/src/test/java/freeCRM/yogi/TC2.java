...
public class TC2 {
	...
	public static void main(String[] args) throws Exception {
		...
		List<WebElement> menuItems = driver.findElements(By.xpath("(//form[@id='companyForm']/table/tbody/tr/td//*[@value='?'])"));
		...
		for (int i = 1; i <=menuItems.size(); i++) {
			...
			Thread.sleep(5000);
			WebElement webElement = driver.findElement(By.xpath("(//form[@id='companyForm']/table/tbody/tr/td//*[@value='?'])["+i+"]"));
			...
			try {
				...
				while (iterator.hasNext()) {
					...
					if (!currentwindowid.equals(homepage)) {
						...
						driver.close();
						// String txt11=
						// driver.findElement(By.xpath("//*[contains(text(),'"+txt1+"')]/following::p[1]")).getText();
