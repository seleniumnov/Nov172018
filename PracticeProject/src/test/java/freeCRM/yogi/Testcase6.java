...
public static void main(String[] args) throws Exception {
	...
	Thread.sleep(30000);
	//gettable count
	List<WebElement> TableElements=driver.findElements(By.xpath("//div[@id='dispAlertMessage']/following::table[7]/tbody/tr"));
	...
	//dropdown value getting code	
	 Select archiveList = new Select(driver.findElement(By.xpath("//select[@name='auditSize']")));
	  ...
	  if(str.equals(selectedValue))
	  {
		  ...
		  for (WebElement webElement : driver.findElements(By.xpath("//div[@id='dispAlertMessage']/following::table[7]/tbody/tr/td[3]"))) {
